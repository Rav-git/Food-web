  ...
  return (
    <div className='policy-page'>
      <div className="policy-hero">
        ...
        <p className="policy-date">Last updated on 01-05-2026 17:49:18</p>
      </div>
      <div className="policy-container">
        <div className="policy-card">
          <p className="policy-intro">
            These Terms and Conditions constitute a binding agreement by and between RAVI
            ("Website Owner" or "we" or "us" or "our") and you ("you" or "your") and relate
            to your use of our website, goods and services (collectively, "Services").
          </p>
          <p>
            ...
            these Terms at any time. It is your responsibility to periodically review these Terms.
          </p>
          <p>The use of this website or availing of our Services is subject to the following terms:</p>
          <ul className="policy-list">
            ...
            <li>You agree and acknowledge that the website and Services may contain links to other third party websites governed by their own terms of use and privacy policies.</li>
            ...
            <li>You shall be entitled to claim a refund of the payment made by you in case we are not able to provide the Service, within the time period provided in our policies. If you do not raise a refund claim within the stipulated time, you will be ineligible for a refund.</li>
            <li>The parties shall not be liable for any failure to perform an obligation under these Terms if performance is prevented or delayed by a force majeure event.</li>
            <li>These Terms shall be governed by and construed in accordance with the laws of India.</li>
            <li>All disputes shall be subject to the exclusive jurisdiction of the courts in Faridabad Sector 22, Haryana.</li>
