    ...
    <div className='policy-page'>
      ...
      <div className="policy-container">
        <div className="policy-card">
          ...
          <h3 className="policy-section-title">1. Shipping Coverage</h3>
          <ul className="policy-list">
            <li>We currently ship to all serviceable PIN codes across India through our trusted logistics partners.</li>
            <li>International shipping is not available at this time. We are working to expand our delivery network soon.</li>
          </ul>

          <h3 className="policy-section-title">2. Processing Time</h3>
          <ul className="policy-list">
          ...
          <h3 className="policy-section-title">3. Delivery Timelines</h3>
          <ul className="policy-list">
          ...
          <h3 className="policy-section-title">4. Shipping Charges</h3>
          <ul className="policy-list">
            <li><strong>Free Shipping</strong> on all orders above ₹999.</li>
            <li>A flat shipping fee of <strong>₹99</strong> applies to orders below ₹999.</li>
          ...
          <h3 className="policy-section-title">5. Order Tracking</h3>
          <ul className="policy-list">
          ...
          <h3 className="policy-section-title">6. Failed Delivery Attempts</h3>
          <ul className="policy-list">
          ...
          <h3 className="policy-section-title">7. Damaged or Lost Shipments</h3>
          <ul className="policy-list">
